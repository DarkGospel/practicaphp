...
class controlador {
  ...
  public function deluser() {
    ...
    if (isset($_GET['id']) && (is_numeric($_GET['id']))) {
      ...
      if ($resultModelo["correcto"]) :
        //Realizamos la insercion en logs
        $resultado = $this->modelo->verificarlogs($nombre, $rol, "Eliminó usuario");
        $this->mensajes[] = [
            "tipo" => "success",
...
// Si se ha pulsado el botón actualizar...
    if (isset($_POST['submit'])) { //Realizamos la actualización con los datos existentes en los campos
      ...
      if (count($errores) == 0) {
        ...
        if ($resultModelo["correcto"]) :
            $resultado = $this->modelo->verificarlogs($nombre, $rol, "Modifico usuario");
          $this->mensajes[] = [
              "tipo" => "success",
...
// Si se ha pulsado el botón actualizar...
  ...
  public function activar() {
       if (isset($_GET['id']) && (is_numeric($_GET['id']))) {
        ...
        if ($resultModelo["correcto"]) :
            $nombre = $_SESSION["usuario"];
            $rol = $_SESSION["rol"];
            $resultado = $this->modelo->verificarlogs($nombre, $rol, "Alta a usuario");
          $this->mensajes[] = [
              "tipo" => "success",
  ...
  public function desactivar() {
       if (isset($_GET['id']) && (is_numeric($_GET['id']))) {
        ...
        if ($resultModelo["correcto"]) :
            $nombre = $_SESSION["usuario"];
            $rol = $_SESSION["rol"];
            $resultado = $this->modelo->verificarlogs($nombre, $rol, "Baja a usuario");
          $this->mensajes[] = [
              "tipo" => "success",
  ...
  public function exportarpdf(){
      ob_start();
      $resultModelo = $this->modelo->listadoexportar();
      $parametros["datos"] = $resultModelo["datos"];
      $html = ob_get_clean();
      ...
      $html2pdf->writeHTML('<h1>Listar usuarios</h1>');
      $html2pdf->writeHTML($d["NIF"]);
